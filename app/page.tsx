          ...
          <div className="max-w-xl">
            ...
            <ScrollReveal delay={160}>
              <div className="space-y-4 text-muted-foreground leading-relaxed max-w-md">
                <p>
                  I build things for the web and spend the rest of my time
                  reading, watching films, and listening to music. This site
                  is a window into what I&apos;m into.
                </p>
                <p>
                  Browse the blog for what I&apos;ve been thinking about, or
                  check out the life section for what I&apos;ve been watching
                  and listening to.
                </p>
              </div>
            </ScrollReveal>
